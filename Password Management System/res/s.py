...
def showSignature():
    text = 'This project was made by Ansh Thapliyal, Utkarsh Sharma, Jayant Choubey, Satya Sai Koushik for the Software Engineering and Project Management Lab Assignment for 2nd year, 4th semester.\n Password Management System allows users to store they account details and passwords securely and access them according their need.'
    return text
