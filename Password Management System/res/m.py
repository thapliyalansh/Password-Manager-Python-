...
def showWindow():
    ...
    window_height = "190" if d.countAccounts() == -1 else str(190 + (d.countAccounts() * 35))
    roots.geometry('700x'+window_height)
    roots.resizable(0,0)
...
def showSignature():
    text='This project was made by Ansh Thapliyal,Utkarsh Sharma,Jayant Choubey,Satya Sai Koushik for the Software Engineering and Project Management Assignment of the 4th Semester'
    return text
