...
def showSignature():
    text='This project was made by Ansh, Utkarsh,Jayant,Satya Sai for Software Engineering and Project Management Assignment for 4th Semester. '
    return text
...
# This fucntion adds our signature
def showSignature():
    text = 'This project was made by Ansh, Utkarsh,Jayant,Satya Sai for SEPM Assignment of 4th semester.'
    return text
...
print(
    "This project was made by Ansh,Utkarsh,Jayant and Satya Sai for SEPM assignment of 4th semester.")
